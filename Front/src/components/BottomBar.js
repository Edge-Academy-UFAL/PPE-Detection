  ...
  return (
    <View style={styles.container}>
      <View style={styles.menuContainer}>
        ...
        >
          <Image
            source={activeButton == 'Home' ? homeIconActive : homeIcon}
            style={styles.imgIcon}
          />
          <Text
            style={[styles.textContent, activeButton === 'Home' && styles.activeText]}
          >
            Home
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.buttonTouch,
            activeButton === 'VideoFeed' && styles.activeButton,
          ]}
          onPress={() => handleNavigate('VideoFeed')}
        >
          <Image
          ...
          <Text
            style={[
              styles.textContent,
              activeButton === 'VideoFeed' && styles.activeText,
            ]}
          >
            BigBrother
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.buttonTouch,
            activeButton === 'SendPhoto' && styles.activeButton,
          ]}
          onPress={() => handleNavigate('SendPhoto')}
        >
          <Image
            source={activeButton == 'SendPhoto' ? falcaoIconActive : falcaoIcon}
            style={styles.imgIconFalcao}
          />
          <Text
            style={[
              styles.textContent,
              activeButton === 'SendPhoto' && styles.activeText,
            ]}
          >
            Falcão
          </Text>
        ...
        <TouchableOpacity
          style={[styles.buttonTouch, activeButton === 'Settings' && styles.activeButton]}
        ...
        >
          ...
          />
          <Text
            style={[styles.textContent, activeButton === 'Settings' && styles.activeText]}
          >
            Configurações
          </Text>
        </TouchableOpacity>
